...
class CustomerTest extends \PHPUnit_Framework_TestCase
{
    ...
    function testCreateCustomerWithAndroidPayCard()
    {
        ...
        $this->assertTrue($androidPayCard instanceof AndroidPayCard);
    ...
    {
        $result = Customer::create(array('firstName' => '<>&"\''));
        $this->assertEquals(true, $result->success);
    ...
    function testCreate_withValidationErrors()
    {
        ...
        $this->assertEquals(Error_Codes::CUSTOMER_EMAIL_IS_INVALID, $errors[0]->code);
        $errors = $result->errors->forKey('customer')->forKey('creditCard')->onAttribute('number');
        $this->assertEquals(Error_Codes::CREDIT_CARD_NUMBER_INVALID_LENGTH, $errors[0]->code);
        $errors = $result->errors->forKey('customer')->forKey('creditCard')->forKey('billingAddress')->onAttribute('streetAddress');
        $this->assertEquals(Error_Codes::ADDRESS_STREET_ADDRESS_IS_TOO_LONG, $errors[0]->code);
    }
    ...
    function testUpdate()
    {
        ...
        $this->assertEquals(true, $result->success);
        $customer = $result->customer;
        $updateResult = Customer::update($customer->id, array(
            'firstName' => 'New First',
            'lastName'  => 'New Last',
            'company'   => 'New Company',
    ...
    function testUpdate_withCountry()
    {
        ...
        $result = Customer::update($customer->id, array(
            'firstName'  => 'Bat',
            'lastName'   => 'Manderson',
            'creditCard' => array(
                'options'        => array(
    ...
    {
        $create_result = Customer::create(array(
            'firstName'  => 'Old First',
            'lastName'   => 'Old Last',
            'website'    => 'http://old.example.com',
            'creditCard' => array(
    ...
    function testUpdate_worksWithFuturePayPalNonce()
    {
        ...
        $result = Customer::update($customerResult->customer->id, array(
            'paymentMethodNonce' => $nonce
        ));
    ...
    function testUpdateNoValidate()
    {
        ...
        $this->assertEquals(true, $result->success);
        $customer = $result->customer;
        $updated = Customer::updateNoValidate($customer->id, array(
            'firstName' => 'New First',
            'lastName'  => 'New Last',
            'company'   => 'New Company',
            'email'     => 'new.email@example.com',
    ...
    function testCreateFromTransparentRedirect()
    {
        ...
        $result = Customer::createFromTransparentRedirect($queryString);
        $this->assertTrue($result->success);
    ...
    function testCreateFromTransparentRedirect_withValidationErrors()
    {
        ...
        $this->assertEquals(Error_Codes::CUSTOMER_FIRST_NAME_IS_TOO_LONG, $errors[0]->code);
        $errors = $result->errors->forKey('customer')->forKey('creditCard')->onAttribute('number');
        $this->assertEquals(Error_Codes::CREDIT_CARD_NUMBER_INVALID_LENGTH, $errors[0]->code);
        $errors = $result->errors->forKey('customer')->forKey('creditCard')->onAttribute('expirationDate');
        $this->assertEquals(Error_Codes::CREDIT_CARD_EXPIRATION_DATE_IS_REQUIRED, $errors[0]->code);
    }
    ...
    function testUpdateFromTransparentRedirect()
    {
        ...
        $result = Customer::updateFromTransparentRedirect($queryString);
        $this->assertTrue($result->success);
        $this->assertEquals('Joe', $result->customer->firstName);
        $this->assertEquals('Martin', $result->customer->lastName);
    ...
    function testSale_createsASaleUsingGivenToken()
    {
        ...
        $creditCard = $customer->creditCards[0];
        $result = Customer::sale($customer->id, array(
            'amount' => '100.00'
        ));
        $this->assertTrue($result->success);
    ...
    function testSaleNoValidate_createsASaleUsingGivenToken()
    {
        ...
        $creditCard = $customer->creditCards[0];
        $transaction = Customer::saleNoValidate($customer->id, array(
            'amount' => '100.00'
        ));
    ...
    function testCredit_createsACreditUsingGivenCustomerId()
    {
        ...
        $creditCard = $customer->creditCards[0];
        $result = Customer::credit($customer->id, array(
            'amount' => '100.00'
        ));
        $this->assertTrue($result->success);
        $this->assertEquals('100.00', $result->transaction->amount);
    ...
    function testCreditNoValidate_createsACreditUsingGivenId()
    {
        ...
        $creditCard = $customer->creditCards[0];
        $transaction = Customer::creditNoValidate($customer->id, array(
            'amount' => '100.00'
        ));
        $this->assertEquals('100.00', $transaction->amount);
