...
class Braintree_TransactionTest extends PHPUnit_Framework_TestCase
{
    ...
    function testCreateTransactionUsingFakeAndroidPayNetworkTokenNonce()
    {
        $result = Braintree_Transaction::sale(array(
            'amount' => '47.00',
        ...
        $this->assertEquals('47.00', $transaction->amount);
        $androidPayCardDetails = $transaction->androidPayCardDetails;
        $this->assertSame(Braintree_CreditCard::MASTER_CARD, $androidPayCardDetails->cardType);
        $this->assertSame("4444", $androidPayCardDetails->last4);
        $this->assertNull($androidPayCardDetails->token);
        $this->assertSame(Braintree_CreditCard::MASTER_CARD, $androidPayCardDetails->virtualCardType);
        $this->assertSame("4444", $androidPayCardDetails->virtualCardLast4);
        $this->assertSame(Braintree_CreditCard::MASTER_CARD, $androidPayCardDetails->sourceCardType);
    ...
    function testCreateTransactionUsingFakeAmexExpressCheckoutNonce()
    {
        $result = Braintree_Transaction::sale(array(
            'amount' => '47.00',
            'merchantAccountId' => Braintree_TestHelper::fakeAmexDirectMerchantAccountId(),
            'paymentMethodNonce' => Braintree_Test_Nonces::$amexExpressCheckout
        ));
        ...
        $this->assertSame(Braintree_CreditCard::AMEX, $amexExpressCheckoutCardDetails->cardType);
    ...
    function testCreate_withPayPalDescription()
    {
        $paymentMethodToken = 'PAYPAL_TOKEN-' . strval(rand());
        $http = new Braintree_HttpClientApi(Braintree_Configuration::$global);
        $nonce = $http->nonceForPayPalAccount(array(
    ...
    function testSale_withAmexRewardsSucceeds()
    {
        $result = Braintree_Transaction::sale(array(
            'amount' => '47.00',
            'merchantAccountId' => Braintree_TestHelper::fakeAmexDirectMerchantAccountId(),
            'creditCard' => array(
                'cardholderName' => 'The Cardholder',
                'number' => Braintree_Test_CreditCardNumbers::$amexPayWithPoints['Success'],
                'expirationDate' => '05/12'
            ),
            'options' => array(
                'submitForSettlement' => true,
    ...
    function testSale_withAmexRewardsSucceedsEvenIfCardIsIneligible()
    {
        $result = Braintree_Transaction::sale(array(
            'amount' => '47.00',
            'merchantAccountId' => Braintree_TestHelper::fakeAmexDirectMerchantAccountId(),
            'creditCard' => array(
                'cardholderName' => 'The Cardholder',
                'number' => Braintree_Test_CreditCardNumbers::$amexPayWithPoints['IneligibleCard'],
                'expirationDate' => '05/12'
            ),
            'options' => array(
                'submitForSettlement' => true,
    ...
    function testSale_withAmexRewardsSucceedsEvenIfCardBalanceIsInsufficient()
    {
        $result = Braintree_Transaction::sale(array(
            ...
            'creditCard' => array(
                'cardholderName' => 'The Cardholder',
                'number' => Braintree_Test_CreditCardNumbers::$amexPayWithPoints['InsufficientPoints'],
                'expirationDate' => '05/12'
            ),
            'options' => array(
                'submitForSettlement' => true,
    ...
    function testSubmitForSettlement_withAmexRewardsSucceedsEvenIfCardIsIneligible()
    {
        $result = Braintree_Transaction::sale(array(
            'amount' => '47.00',
            'merchantAccountId' => Braintree_TestHelper::fakeAmexDirectMerchantAccountId(),
