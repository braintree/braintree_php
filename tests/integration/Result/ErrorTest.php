...
class Result_ErrorTest extends \PHPUnit_Framework_TestCase
{
    function testValueForHtmlField()
    {
        ...
        $this->assertEquals('invalid-country',
            $result->valueForHtmlField('customer[credit_card][billing_address][country_name]'));
