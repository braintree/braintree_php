...
class Braintree_Error_Codes
{
    ...
    const SERVICE_FEE_AMOUNT_CANNOT_BE_NEGATIVE = "92501";
    const SERVICE_FEE_AMOUNT_FORMAT_IS_INVALID = "92503";
    const SERVICE_FEE_AMOUNT_IS_REQUIRED = "92502";
    const SERVICE_FEE_AMOUNT_IS_TOO_LARGE = "92504";
    const SERVICE_FEE_MASTER_MERCHANT_ACCOUNT_DOES_NOT_SUPPORT_SERVICE_FEES = "92510";
    const SERVICE_FEE_MERCHANT_ACCOUNT_CANNOT_BE_A_SUB = "92509";
    const SERVICE_FEE_MERCHANT_ACCOUNT_CANNOT_MATCH_TRANSACTION_MERCHANT_ACCOUNT = "92507";
    const SERVICE_FEE_MERCHANT_ACCOUNT_CURRENCIES_MUST_MATCH = "92508";
    const SERVICE_FEE_MERCHANT_ACCOUNT_ID_IS_INVALID = "92506";
    const SERVICE_FEE_MERCHANT_ACCOUNT_NOT_SUPPORTED = "92505";
    ...
    const TRANSACTION_SUB_MERCHANT_ACCOUNT_REQUIRES_SERVICE_FEE                 = '91553';
