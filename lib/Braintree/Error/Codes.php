...
class Braintree_Error_Codes
{
    ...
    const MERCHANT_ACCOUNT_BUSINESS_NAME_IS_INVALID              = '82646';
    const MERCHANT_ACCOUNT_BUSINESS_TAX_ID_IS_INVALID            = '82647';
    const MERCHANT_ACCOUNT_BUSINESS_TAX_ID_IS_REQUIRED_WITH_NAME = '82648';
    const MERCHANT_ACCOUNT_BUSINESS_NAME_IS_REQUIRED_WITH_TAX_ID = '82669';
    ...
    const MERCHANT_ACCOUNT_INDIVIDUAL_EMAIL_ADDRESS_IS_INVALID  = '82643';
    ...
    const MERCHANT_ACCOUNT_INDIVIDUAL_EMAIL_ADDRESS_IS_REQUIRED = '82667';
